      ...
      >
        <div className="mx-auto flex max-w-[1400px] items-center gap-6 px-5 py-4 lg:px-10">
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <button
              type="button"
              className="hidden size-10 items-center justify-center rounded-full border border-border text-foreground/70 transition-colors hover:border-primary hover:text-primary sm:flex"
